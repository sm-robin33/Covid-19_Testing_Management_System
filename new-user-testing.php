...
$query="insert into tblpatients(FullName,MobileNumber,DateOfBirth,NID,FullAddress,District) values('$fname','$mnumber','$dob','$govtnid','$address','$District');";
...
<form name="newtesting" method="post">
                        ...
                        <div class="form-group">
                            <label>Full Name</label>
                                  ...
                                  <input type="text" class="form-control" id="mobilenumber" name="mobilenumber" placeholder="Please enter your mobile number" pattern="[0-9]{11}" title="11 numeric characters only" required="true" onBlur="mobileAvailability()">
                                        ...
                                        <div class="form-group">
                                               <label>NID</label>
                                            <input type="text" class="form-control" id="NID" name="NID" placeholder="NID" required="true">
                                        </div>
 ...
 <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="District" name="District" placeholder="Enter your District Here" required="true">
                                        </div>
